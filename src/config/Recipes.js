...
export const RECIPES = [
    ...
    { id: 'mod_tesla_1', name: 'Bobina de Cobre', type: 'tower_part', subType: 'tesla', prof: 'engineering', mat: 'ingot_copper', cost: 350, tier: 1, baseStats: { attackSpeed: 50, damage: 5 } },
    { id: 'mod_poison_1', name: 'Inyector de Cuero', type: 'tower_part', subType: 'poison', prof: 'engineering', mat: 'leather_simple', cost: 320, tier: 1, baseStats: { damage: 4, range: 20 } },
    { id: 'mod_quake_1', name: 'Peso de Hierro', type: 'tower_part', subType: 'quake', prof: 'engineering', mat: 'ingot_iron', cost: 400, tier: 1, baseStats: { damage: 15, aoe: 10 } },


    // ============================================================
    // TIER 1.5: ESPECIALES (Desbloqueables por Misión)
    // ============================================================
