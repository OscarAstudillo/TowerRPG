...
export const TOWER_TYPES = {
    archer: {
        ...
        type: 'archer',
        levels: [
            { damage: 15, range: 210, fireRate: 800, upgradeCost: 150 }, // Lv1
            { damage: 25, range: 230, fireRate: 700, upgradeCost: 250 }, // Lv2
            { damage: 40, range: 250, fireRate: 600, upgradeCost: 400 }  // Lv3 (Max base)
        ],
        evolutions: {
            pathA: {
                key: 'sniper', name: 'Francotirador', 
                desc: 'Rango y daño masivo. Lento.',
                stats: { damage: 150, range: 400, fireRate: 1500, critChance: 0.5 },
            ...
            pathB: {
                ...
                stats: { damage: 30, range: 280, fireRate: 250 }, // Muy rápido
    ...
    cannon: {
        ...
        type: 'cannon',
        levels: [
            { damage: 30, range: 600, fireRate: 2000, upgradeCost: 250, aoe: 100 },
            { damage: 50, range: 700, fireRate: 1900, upgradeCost: 350, aoe: 110 },
            { damage: 80, range: 800, fireRate: 1800, upgradeCost: 550, aoe: 120 }
        ],
        evolutions: {
            pathA: {
                key: 'devastator', name: 'Devastador', 
                desc: 'Explosiones nucleares.',
                stats: { damage: 200, range: 900, fireRate: 2500, aoe: 180 },
            ...
            pathB: {
                ...
                stats: { damage: 20, range: 900, fireRate: 150, aoe: 0 }, // Sin parábola
