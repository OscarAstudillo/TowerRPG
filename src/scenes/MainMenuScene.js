...
export default class MainMenuScene extends Phaser.Scene {
    ...
    createInventoryView(w, h, cx, cy) {
        ...
        // Recuadro de detalle con tamaño dinámico
        const bg = this.add.rectangle(0, 0, 320, 300, 0x000000, 0.95).setStrokeStyle(2, 0xffffff);
    ...
    refreshInventory() { 
        ...
        if (this.inventoryCategory === 'mats') { 
            // Mostrar lista completa de materiales
            matContent += "--- RECURSOS ---\n";
    ...
    // --- VISTA TALENTOS MEJORADA (SCROLLABLE) ---
