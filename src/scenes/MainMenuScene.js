...
export default class MainMenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        if (!this.hasLoaded) {
            ...
            this.sanitizeData(); // Limpieza inicial crítica
            this.hasLoaded = true;
        }
    ...
    // --- LIMPIEZA DE DATOS (ANTI-FANTASMAS) ---
    sanitizeData() {
        // Elimina items que dicen estar en inventario pero tienen el mismo ID que algo equipado
        ...
        // Filtrar inventario: Solo dejar items que NO están equipados
    ...
    removeItemFromInventory(item) {
        ...
        // Filtra por ID único, eliminando duplicados si los hubiera
    ...
    actionEquip() { 
        ...
        if (!realItem) {
            this.showCentralAlert("Error: Item fantasma detectado", "#ff0000");
    ...
    executeFusion() { 
        ...
        // 1. Validar que ambos existen antes de empezar
        ...
        if (result.success) { 
            // 2. BORRADO ATÓMICO: Filtrar ambos IDs de una vez del array
