...
export default class MainMenuScene extends Phaser.Scene {
    ...
    showUnequipModal(item, slotKey) {
        ...
        btnUnequip.on('pointerdown', () => { gameState.equipment[slotKey] = null; gameState.inventory.push(item); SaveSystem.save(); updatePlayerStats(); this.refreshHero(); modal.destroy(); });
    ...
    createForgeView(w, h, cx, cy) {
        ...
        // FONDO AUMENTADO PARA QUE QUEPA TODO
