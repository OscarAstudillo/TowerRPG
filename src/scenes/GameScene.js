...
export default class GameScene extends Phaser.Scene {
    ...
    addEnemyReward(amount) { 
        ...
        // Feedback visual de monedas (Texto Flotante Dorado)
        // Usamos una posición aleatoria cerca del centro superior o donde murió si pudiéramos
        // Como addEnemyReward se llama desde Enemy, no tenemos XY aquí fácil, 
        // pero podemos hacer que salte desde el contador de monedas.
        const floatTxt = this.add.text(80, 850, `+$${amount}`, { 
            fontSize: '20px', color: '#ffff00', fontStyle: 'bold', stroke: '#000', strokeThickness: 3 
    ...
    createUI() {
        ...
        // BOTÓN OLEADA (Corregido)
        this.waveTimerContainer = this.add.container(640, 60).setScrollFactor(0).setDepth(uiDepth + 2);
        const timerBg = this.add.rectangle(0, 0, 320, 60, 0x006400).setInteractive({ useHandCursor: true }).setStrokeStyle(2, 0xffffff);
        ...
        // Hacemos que tanto el fondo como el texto disparen la acción al hacer clic
